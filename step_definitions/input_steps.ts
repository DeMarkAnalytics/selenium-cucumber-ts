...
Then(/^I clear input field having (id|name|class|xpath|css) "([^\"]*)"$/, async function (this: World, elementType: string, typeValue: string) {
...
Then(/^I check the checkbox having (id|name|class|xpath|css) "(.*?)"$/, async function (this: World, elementType: string, typeValue: string) {
  await input.checkCheckbox(this, elementType, typeValue);
});

Then(/^I uncheck the checkbox having (id|name|class|xpath|css) "(.*?)"$/, async function (this: World, elementType: string, typeValue: string) {
  await input.uncheckCheckbox(this, elementType, typeValue);
});

Then(/^I toggle checkbox having (id|name|class|xpath|css) "(.*?)"$/, async function (this: World, elementType: string, typeValue: string) {
  await input.toggleCheckbox(this, elementType, typeValue);
});

Then(/^I select radio button having (id|name|class|xpath|css) "(.*?)"$/, async function (this: World, elementType: string, typeValue: string) {
